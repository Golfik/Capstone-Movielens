...
edx_test <- edx_test %>% semi_join(edx_train, by = "movieId") %>% semi_join(edx_train, by = "userId") %>% semi_join(edx_train, by="year_of_release") %>% semi_join(edx_train, by="rateday")
...
#Generating predicitons on validation set
